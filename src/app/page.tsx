...
export default function Home() {
  ...
  const projects = [
    ...
    { title: "Voice AI Orchestrator", tech: ["FastAPI", "React", "LangGraph"], desc: "Multi-agent voice AI platform utilizing Vapi for telephony and LangGraph for transcript evaluation.", id: "voice-ai-orchestrator", status: "Production", github: "https://github.com/Harshkumar2306/voice-ai-orchestrator", live: "https://voice-ai-orchestrator.vercel.app/" },
