...
export default function Home() {
  ...
  const projects = [
    ...
    { title: "Voice AI Orchestrator", tech: ["FastAPI", "React", "LangGraph"], desc: "Multi-agent voice AI platform utilizing Vapi for autonomous telephony and LangGraph for complex transcript evaluation. Features dynamic real-time WebSocket syncing and asynchronous FastAPI pipelines.", id: "voice-ai-orchestrator", status: "Production", github: "https://github.com/Harshkumar2306/voice-ai-orchestrator", live: "https://voice-ai-orchestrator.vercel.app/" },
    { title: "ATC Simulator", tech: ["MERN", "WebSocket", "Canvas"], desc: "Real-time ATC simulation with 20Hz backend physics and decoupled 60Hz frontend.", id: "atc-simulator", status: "Production", github: "https://github.com/Harshkumar2306/ATC-Simulator-", live: "https://atc-simulator-five.vercel.app/" },
            ...
            <motion.div key="sec4" variants={slideVariants} initial="initial" animate="enter" exit="exit" className="slide-content slide-content-contact">
              ...
              <section className="section contact-section">
                 <div className="container contact-container">
                   <motion.div variants={childVariants} style={{ textAlign: 'center', marginBottom: 'var(--space-4)' }}>
                      <h2 className="title section-title glitch-title" data-text="LET'S TALK" style={{ marginBottom: 0 }}>LET&apos;S TALK</h2>
